...
//         // Update mode: remove from DB + UploadThing
...
//         });
//       } else {
//         // Create mode: only remove from UploadThing (since DB record not created yet)
...
//       // Update form state instantly (works for both Create and Update)
//       form.setValue(
//         'images',
...
//           method: 'POST',
//           headers: { 'Content-Type': 'application/json' },
//           body: JSON.stringify({ productId, imageUrl: bannerUrl }),
//         });
//       } else {
//         await fetch('/api/uploadthing/delete', {
//           method: 'POST',
...
//       form.setValue('banner', ''); // clear single banner
//       toast({ description: 'Banner deleted successfully' });
//     } catch (error) {
//       toast({ variant: 'destructive', description: 'Failed to delete banner' });
//     }
//   };
